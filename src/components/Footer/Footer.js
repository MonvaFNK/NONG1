            ...
            <div className="flex flex-row footerContainer__item">
                <div className='flex flex-col w-1/2 justify-center items-center'>
                    <div className='flex justify-center items-center py-4'>
                        <Image className='h-full w-2/3' src={AgenciaHispanaFooter} alt="FooterLogo" />
                        {/*                         <h3>Agencia Hispana de Carlos E. Galindo</h3> */}
                    </div>
                    <div className='flex flex-col w-3/4 justify-center items-center'>
                        <p className='footerContainer__item--texto'>Preparadores de documentos legales bilingües, certificados por la corte suprema de Arizona.</p>
                    </div>
                </div>
                <div className='divisor'></div>
                <div className="footerContainer__item flex flex-col justify-center items-center">
                    <div className='w-3/4'>
                        <p>Manutención- Divorcios- Custodia- Divorcios por Publicación- Consulta Gratis</p>
                    </div>
                    <div className="pt-4 w-3/4 flex flex-row justify-evenly items-center">
