...
import GalindoPhoto from '../Images/AgenciaHispana_galindoPhoto.jpg';
            ...
            <main className='main'>
                <section>
                    ...
                    <div className="mainContainer h-screen overflow-hidden">
                        ...
                        <div className='flex flex-row justify-center item center'>
                            <div className='flex flex-col w-2/6  font-bold mainContainer__title items-center justify-center'>
                                <h1 className='flex flex-col mainContainer__titleHeading'>
                                    <span className=' text-slate-100 mainContainer__title--first'>Somos</span>
                                    <span className=' text-red-600  mainContainer__title--text'>Agencia</span>
                                    <span className='  text-red-600 mainContainer__title--text '>Hispana</span>
                                </h1>
                            </div>
                            <div className='flex flex-col w-3/6  py-2 justify-center items-center'>
                                <div className=' justify-self-center h-4/6 mainContainer__image'>
                                    <Image className='h-auto  max-h-full' src={AgenciaHispana} alt="Agencia Hispana Logo" />
                                </div>
                                <p className='text-slate-100 py-10 px-5 font-bold h-2/6 mainContainer__paragraph'>
                ...
                <section >
                    <div className='mainContainer__textBox flex justify-center items-center flex-col pt-10'>
                        <h2 className="w-3/6 mainContainer__textBox--paragraphTitle flex flex-col w-2/5 h-100 font-bold px-5">
                            Con más de 35 años de experiencia, somos sus expertos de confianza en la preparación de documentos legales
                        </h2>
                        <p className='h-100  w-3/5 mainContainer__textBox--paragraph py-10'>
                ...
                <section className='pb-16 pt-10'>
                    <div className='flex justify-center items-center' >
                        <h2 className="text-center w-3/6 mainContainer__textBox--paragraphTitle flex flex-col h-100 font-bold px-5">Te podemos ayudar con:</h2>
                    </div>
                    <div className='flex flex-row justify-evenly items-center'>
                        <div className='servicios w-1/6 h-full flex flex-col items-center justify-center'>
                            <div className='w-full h-full flex flex-col items-center justify-center'>
                                <svg id="Capa_1" className='svg__Icons' data-name="Capa 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 631.54 672.99">
                                    <g>
                                        ...
                                        <path class="manutencion-2" d="m347.21,197.2V50.91S334.16,0,280.13,0s-49.49,49.32-49.49,49.32v147.88h100.57Z" />
                                    ...
                                    <path class="manutencion-2" d="m376.79,430.80c68.58-213.5-232.27-206.57-163.67,0h163.67Z" />
                            ...
                            <p className=' text-center font-bold text-xl '>La manutencion de tus hijos</p>
                        </div>
                        ...
                        <div className='servicios w-1/6 h-full flex flex-col items-center justify-center'>
                            <div className=' w-full h-full flex flex-col items-center justify-center '>
                                <svg id="Capa_1" className='svg__Icons2' data-name="Capa 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 998 597.08">
                                    ...
                                    <polygon class="divorcios-1" points="879.57 120.9 935.09 65.39 978.26 65.39 998 111.03 974.56 140.64 880.84 150.51 879.57 120.9" />
                                </svg>
                            </div>
                            <p className='text-center font-bold text-xl'>Divorcios por publicacion</p>
                        </div>
                        <div className='servicios w-1/6 h-full flex flex-col items-center justify-center'>
                            <div className='w-full h-full flex flex-col items-center justify-center '>
                                <svg id="Capa_1" className='svg__Icons' data-name="Capa 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 608.22 617.3">
                                    <path class="personas-1" d="m180.61,281.42h-14.21C81.66,281.42,0,363.08,0,463.82v151.22h288.23s-11.35-154.33,88.51-189.8c-.01-87.09-79.4-143.82-180.13-143.82" />
                            ...
                            <p className='text-center font-bold text-xl'>Obten la custodia</p>
                        </div>
                    </div>
                </section>
                <section className='expoSection'>
                    <div className='flex justify-center items-center expo w-screen h-screen max-w-full max-h-full'>
                        <div className='flex flex-col text-slate-100 font-bold w-4/6 expo__texto'>Nuestros servicios están diseñados para satisfacer las necesidades de los inmigrantes. Entendemos los desafíos únicos que conlleva ser un inmigrante en un nuevo país, y estamos aquí para ayudarlo a superarlos. Ya sea que necesite ayuda con solicitudes de visa, renovaciones de tarjetas verdes o cualquier otro documento legal.</div>
                        <Image className='expo__backgroundImage h-full w-full max-w-full max-h-full' src={AgenciaHispanaSuit} alt="Agencia Hispana Logo"></Image>
                    </div>
                    <div className='mainContainer__topBarSecondary expoSection__bar' />

                </section>

                <section className='pt-20'>
                    <div className='flex justify-center items-center w-screen max-w-full'>
                        <h2 className='pb-20 mainContainer__textBox--paragraphTitle flex flex-col font-bold'>
                            Infórmate
                        </h2>
                    </div>
                    <div className='flex justify-center items-center w-screen max-w-full'>
                        <div className='w-1/4'>
                            <div className='flex flex-col justify-center items-center'>
                                <div className='bg-slate-600 seeMoreButton w-80'></div>
                                <p className='pt-5 font-bold seeMoreText'>
                                    Ver más
                                </p>
                            </div>
                        </div>
                        <div className='w-1/4'>
                            <div className='flex flex-col justify-center items-center'>
                                <div className='bg-slate-600 seeMoreButton h-80 w-80'></div>
                                <p className='pt-5 font-bold seeMoreText'>
                                    Ver más
                                </p>
                            </div>
                ...
                <section className='py-10'>
                    <div className='galindoBio flex justify-center items-center h-screen w-screen max-w-full max-h-full '>
                        <div className='galindoBio__container w-3/6 flex justify-center items-center'>
                            <div className=' mainContainer__textBox--paragraph galindoBio__container--texto w-1/2'>
                                <p>Carlos Galindo Biografia</p>
                            </div>
                            <div className='galindoBio__container--photo w-1/2'>
                                <Image className='h-auto  max-h-full' src={GalindoPhoto} />
                            </div>
                        </div>
                    </div>
                </section>
